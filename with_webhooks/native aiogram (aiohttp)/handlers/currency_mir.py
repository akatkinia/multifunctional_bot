...
# @dp.callback_query_handler(cb.filter(command='cb_currency_help_mir'), state='*')
...
# @dp.callback_query_handler(cb.filter(command='cb_today_currency_mir'), state='*')
...
# @dp.message_handler(state=ProfileStatesGroup.currency_mir_today_state)
...
# @dp.callback_query_handler(cb.filter(command='currency_mir_currentdate_state'), state='*')
...
# @dp.callback_query_handler(cb.filter(command='cb_chart_mir'), state='*')
...
# @dp.message_handler(state=ProfileStatesGroup.currency_mir_chart_state)
...
def register_handlers_currency_mir(dp: dp):
    # справка
    # dp.register_callback_query_handler(currency_help_mir, cb.filter(command='cb_currency_help_mir'), state=[ProfileStatesGroup.currency_mir_state, ProfileStatesGroup.currency_mir_today_state, ProfileStatesGroup.currency_mir_currentdate_state])
